...
export default {
  ...
  data: function() {
    return {
      finished: [
        {
          title: "American Sunset:<br>Disbelief",
          image: "/assets/images/headers/americanwest.jpg",
          link: "stories/american_disbelief",
      ...
      hooks: [
        ...
        },
        {
          ...
          image: "https://i.imgur.com/OANxEOR.png",
          link: "stories/tinker_spellcaster",
